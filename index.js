 ...
 */
 ...
 const client = redis.createClient(6379, '10.33.77.12');
 ...
 client.connect()
 client.hmSet("lobbies", 'test', 'test_data')
 const sockets = {}
 ...
 io.on('connection', async function (socket) {
   ...
   if ((client_length) === 0) {
     ...
     await client.hmSet('lobbies', lobbyId, JSON.stringify({ "player1": 1, "player2": -1, "socket1": socket.id, "socket2": null }) )
